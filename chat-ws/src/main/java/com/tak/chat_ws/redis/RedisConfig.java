...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisMessageListener(
            ...
            RedisChatTimestampSubscriber redisTimestampSubscriber,
            RedisChatMessageSubscriber redisSubscriber,
            ChannelTopic chatMessageTopic,
            ChannelTopic chatTimestampTopic
    ) {
        RedisMessageListenerContainer container = new RedisMessageListenerContainer();
        container.setConnectionFactory(connectionFactory);
        container.addMessageListener(redisSubscriber, chatMessageTopic);
        container.addMessageListener(redisTimestampSubscriber, chatTimestampTopic);
