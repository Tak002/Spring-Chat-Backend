...
VALUES
    (1, 1),  -- 알고리즘 스터디 OT - 스터디
    (1, 3),  -- 알고리즘 스터디 OT - 게임(알고리즘 문제 풀이 느낌)
    (2, 2),  -- 보드게임 번개 - 친목
    (2, 3);  -- 보드게임 번개 - 게임
...
VALUES
    -- Meeting 1: Alice 호스트, Bob 승인된 멤버
    ...
    -- Meeting 2: Bob 호스트, Alice는 승인 대기 중
...
-- =========================================
-- Dummy data: Join answers (Bob가 스터디에 지원)
-- =========================================
...
VALUES
    -- Bob가 Meeting 1을 스팸으로 신고 (아직 미결)
    (1, 2, 'MEETING', '1', 'SPAM',
     '동일한 내용의 스터디 홍보가 여러 번 올라온 것 같습니다.',
     'PENDING',
     '2025-11-18 11:00:00+09'),
    -- Alice가 Meeting 2를 신고했고, 이미 결정된 상태
    (2, 1, 'MEETING', '2', 'ABUSE',
...
-- id는 DEFAULT gen_random_uuid() 사용
